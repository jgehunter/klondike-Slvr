...
void background (GLuint texture) {
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(0.0, 0.0); glVertex3f(-8.0, 5.0, -4.0);
    glTexCoord2f(0.0, 1.0); glVertex3f(-8.0, 7, 3);
    glTexCoord2f(1.0, 1.0); glVertex3f(8.0, 7, 3);
    glTexCoord2f(1.0, 0.0); glVertex3f(8.0, 5.0, -4.0);
